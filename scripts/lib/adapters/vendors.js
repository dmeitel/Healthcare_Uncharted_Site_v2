    ...
    return vendors.map((v) => {
      ...
      return makeNode({
        ...
        facets: {
          ...
          // schema v2 (2026-08): structured company facts
          ownership: v.ownership || null,
          hcShare: v.hcShare || null,
          hqState: v.hq ? (v.hq.state || v.hq.country || null) : null,
        ...
        searchParts: [v.name, v.owner, sectorLabel, v.sector, v.desc, ...(v.ps || []),
          v.hq ? (v.hq.city + ' ' + (v.hq.state || v.hq.country || '')) : '', v.parent || '', v.ticker || ''],
