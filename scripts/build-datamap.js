...
const NODES = [
  ...
  { id: 'src-cms-dmepos', kind: 'source', label: 'CMS DMEPOS CSV', provenance: 'official',
    detail: 'Supplier directory CSV; build-suppliers.js fetches it from a hardcoded CMS URL.' },
  ...
  { id: 'js-build-suppliers', kind: 'script', label: 'build-suppliers.js', stat: 'scripts/build-suppliers.js',
    detail: 'Fetch-on-build from a hardcoded CMS DMEPOS URL; splits the directory into four supplier datasets.' },
  ...
  { id: 'js-build-entities', kind: 'script', label: 'build-entities.js', stat: 'scripts/build-entities.js',
    detail: '10-adapter unified graph. Reads every major dataset, validates links, writes the search graph.' },
