...
- /tools/operators-map/ IS the v2 (all seven layers, icons, draw search, insets, system drill, county profiles, GPS). The D3 v1: archive/operators-map-2026-07-19-d3-v1.html.
