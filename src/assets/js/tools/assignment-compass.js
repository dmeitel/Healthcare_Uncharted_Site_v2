...
function syncUrl(s) {
  ...
  if (s.mode === 'h') { p.set('hr', String(num('acHourly'))); if (num('acHours') !== 36) p.set('hw', String(num('acHours'))); }
  else p.set('g', s.gross);
  if (s.offerMode) {
    if (s.mode === 'h') { p.set('hr2', String(num('acHourly2'))); if (num('acHours2') !== 36) p.set('hw2', String(num('acHours2'))); }
