...
const CURATED = [
  ...
  { name: 'NBRC · Examinations in Review', tag: 'NBRC', org: 'clinical',
    url: 'https://www.nbrc.org/wp-content/uploads/2026/02/2025-Exams-in-Review-Info-Sheet.pdf',
    desc: 'Respiratory therapy exam pass rates: TMC, CSE, and the ACCS/NPS/SDS specialty boards.',
    usedBy: [USE.career] },
  { name: 'BCEN · Certification Exam Statistics', tag: 'BCEN', org: 'clinical',
    url: 'https://bcen.org/about-us/certification-exam-statistics/',
    desc: 'Emergency nursing certification exam counts (CEN and peers).',
    usedBy: [USE.career] },
  ...
  // — Credentialing boards, round 2 (the 2026-07-12 expansion: behavioral, sleep, imaging modalities, periop, lactation, opticianry, case management, massage, oncology nursing) —
  { name: 'BACB · Certificant &amp; Examination Data', tag: 'BACB', org: 'clinical',
    url: 'https://www.bacb.com/about/bacb-certificant-annual-report-data/',
    desc: 'RBT and BCBA examination pass rates and certificant counts.',
    usedBy: [USE.career] },
  { name: 'BRPT · RPSGT Handbook & Annual Report', tag: 'BRPT', org: 'clinical',
    url: 'https://brpt.org/rpsgt/rpsgt-handbook/',
    desc: 'Polysomnographic technologist eligibility pathways and exam data.',
    usedBy: [USE.career] },
  { name: 'NMTCB · Annual Report', tag: 'NMTCB', org: 'clinical',
    url: 'https://www.nmtcb.org/documents/exams/annual-reports/Annual-Report-2024.pdf',
    desc: 'Nuclear medicine technologist certification exam statistics.',
    usedBy: [USE.career] },
  { name: 'JRCNMT · Program Directory', tag: 'JRCNMT', org: 'clinical',
    url: 'https://www.jrcnmt.org/find-a-program/',
    desc: 'Accredited nuclear medicine technology program directory.',
    usedBy: [USE.career] },
  { name: 'CCI · CNOR Certification Statistics', tag: 'CCI', org: 'clinical',
    url: 'https://info.cc-institute.org/certification-statistics',
    desc: 'Perioperative nursing certification pass rates.',
    usedBy: [USE.career] },
  { name: 'IBLCE · IBCLC Test Analysis Report', tag: 'IBLCE', org: 'clinical',
    url: 'https://ibclc-commission.org/wp-content/uploads/2026/03/2025_September_IBCLC_Test_Analysis_Report_Executive_Summary_Final.pdf',
    desc: 'Lactation consultant exam statistics (worldwide) and pathways.',
    usedBy: [USE.career] },
  { name: 'ABO-NCLE · Basic Exam Statistics', tag: 'ABO', org: 'clinical',
    url: 'https://www.abo-ncle.org/ABONCLE/ABONCLE/Exams/ABO-NCLE-Exams/ABO-NCLE-Basic-Exam.aspx',
    desc: 'Opticianry certification exam data and requirements.',
    usedBy: [USE.career] },
  { name: 'CCMC · CCM Exam FAQs & Statistics', tag: 'CCMC', org: 'clinical',
    url: 'https://ccmcertification.org/get-certified/certification/exam-specific-faqs',
    desc: 'Case manager certification eligibility and pass rates.',
    usedBy: [USE.career] },
  { name: 'FSMTB · Annual Report (MBLEx)', tag: 'FSMTB', org: 'clinical',
    url: 'https://fsmtb.org/wp-content/uploads/2025/10/FSMTB-Annual-Report-2025.pdf',
    desc: 'Massage and bodywork licensing exam first-time pass rates.',
    usedBy: [USE.career] },
  { name: 'ONCC · Examination Statistics & Pass Rates', tag: 'ONCC', org: 'clinical',
    url: 'https://www.oncc.org/sites/default/files/2025-02/2024_Examination_Statistics_and_Pass%20Rates.pdf',
    desc: 'Oncology nursing certification exam statistics.',
    usedBy: [USE.career] },

  // — Program accreditors & entry requirements (Career Tree on-ramp: getting-in data + program locators) —
  { name: 'ACEN · Accredited Nursing Program Search', tag: 'ACEN', org: 'clinical',
    url: 'https://www.acenursing.org/search-programs',
    desc: 'Accredited nursing program directory (PN through graduate).',
    usedBy: [USE.career] },
  { name: 'CCNE · Accredited Program Directory', tag: 'CCNE', org: 'clinical',
    url: 'https://directory.ccnecommunity.org/',
    desc: 'Baccalaureate and graduate nursing program directory.',
    usedBy: [USE.career] },
  { name: 'COA · Nurse Anesthesia Program Search & Entry Requirements', tag: 'COA', org: 'clinical',
    url: 'https://www.coacrna.org/programs-fellowships/crna-school-search/',
    desc: 'CRNA program directory; COA sets the 1-year critical-care entry floor.',
    usedBy: [USE.career] },
  { name: 'ACME · Accredited Midwifery Education Programs', tag: 'ACME', org: 'clinical',
    url: 'https://theacme.org/accredited-midwifery-education-programs/',
    desc: 'Nurse-midwifery program directory and entry pathways.',
    usedBy: [USE.career] },
  { name: 'eCFR · 42 CFR 483.152 Nurse Aide Training Requirements', tag: 'eCFR', org: 'government',
    url: 'https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483/subpart-D/section-483.152',
    desc: 'The federal 75-hour nurse aide training and evaluation floor.',
    usedBy: [USE.career] },
  { name: 'JRCERT · Find a Program', tag: 'JRCERT', org: 'clinical',
    url: 'https://www.jrcert.org/find-a-program/',
    desc: 'Accredited radiography and imaging program directory.',
    usedBy: [USE.career] },
  { name: 'CAAHEP · Find an Accredited Program', tag: 'CAAHEP', org: 'clinical',
    url: 'https://www.caahep.org/students/find-an-accredited-program',
    desc: 'Accredited allied-health program directory (sonography, paramedic, surgical tech, CVT, and peers).',
    usedBy: [USE.career] },
  { name: 'NAACLS · Program Search', tag: 'NAACLS', org: 'clinical',
    url: 'https://naacls.org/naacls-program-search/',
    desc: 'Accredited laboratory science program directory (MLS, MLT, phlebotomy).',
    usedBy: [USE.career] },
  { name: 'CoARC · Find an Accredited Program', tag: 'CoARC', org: 'clinical',
    url: 'https://coarc.com/students/find-an-accredited-program/',
    desc: 'Accredited respiratory care program directory.',
    usedBy: [USE.career] },
  { name: 'CAPTE · Accredited PT & PTA Program Directory', tag: 'CAPTE', org: 'clinical',
    url: 'https://aptaapps.apta.org/accreditedschoolsdirectory/AllPrograms.aspx',
    desc: 'Accredited physical therapy and PTA program directory.',
    usedBy: [USE.career] },
  { name: 'ACOTE · School Directory', tag: 'ACOTE', org: 'clinical',
    url: 'https://acoteonline.org/all-schools/',
    desc: 'Accredited occupational therapy and OTA program directory.',
    usedBy: [USE.career] },
  { name: 'ASHA · EdFind Program Search', tag: 'ASHA', org: 'clinical',
    url: 'https://find.asha.org/ed/',
    desc: 'Accredited speech-language pathology and audiology graduate program search.',
    usedBy: [USE.career] },
  { name: 'CAATE · Program Directory', tag: 'CAATE', org: 'clinical',
    url: 'https://accreditation.caate.net/directory/',
    desc: 'Accredited athletic training program directory.',
    usedBy: [USE.career] },
  { name: 'ACEND · Accredited Program Directory', tag: 'ACEND', org: 'clinical',
    url: 'https://www.eatrightpro.org/acend/accredited-programs/program-directory',
    desc: 'Accredited nutrition and dietetics program directory.',
    usedBy: [USE.career] },
  { name: 'ACPE · PharmD Program Lookup', tag: 'ACPE', org: 'clinical',
    url: 'https://www.acpe-accredit.org/program-lookup/?_insitution-program=pharmd',
    desc: 'Accredited Doctor of Pharmacy program directory.',
    usedBy: [USE.career] },
  { name: 'PharmCAS · Standardized Tests & Prerequisites', tag: 'PharmCAS', org: 'clinical',
    url: 'https://www.pharmcas.org/application-instructions/standardized-tests',
    desc: 'Pharmacy admissions requirements; documents the PCAT retirement.',
    usedBy: [USE.career] },
  { name: 'ARC-PA · Currently Accredited Programs', tag: 'ARC-PA', org: 'clinical',
    url: 'https://www.arc-pa.org/entry-level-program/currently-accredited-programs/',
    desc: 'Accredited physician assistant program list.',
    usedBy: [USE.career] },
  { name: 'PAEA · Program Report 36', tag: 'PAEA', org: 'clinical',
    url: 'https://paeaonline.org/wp-content/uploads/2024/02/PAEA-PR36-final-v5-3_updated-2-9-24.pdf',
    desc: 'PA program admissions data: GRE/CASPer prevalence, matriculant patient-care hours.',
    usedBy: [USE.career] },
  { name: 'CAHIIM · Program Directory', tag: 'CAHIIM', org: 'clinical',
    url: 'https://www.cahiim.org/programs/program-directory/',
    desc: 'Accredited health information program directory (RHIT, RHIA).',
    usedBy: [USE.career] },
  { name: 'NREMT · State EMS Offices', tag: 'NREMT', org: 'clinical',
    url: 'https://www.nremt.org/Resources/State-EMS-offices',
    desc: 'State EMS office directory; states set EMT course entry rules.',
    usedBy: [USE.career] },
  { name: 'PTCB · Recognized Education/Training Program Directory', tag: 'PTCB', org: 'clinical',
    url: 'https://ptcb.org/ptcb-recognized-education-training-program-directory/',
    desc: 'Recognized pharmacy technician training program directory.',
    usedBy: [USE.career] },
