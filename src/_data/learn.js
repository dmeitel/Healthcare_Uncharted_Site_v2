const learn = {
  ...
  modules: [
...

    {
      ...
      desc:     'The recurring patterns that shape healthcare and health IT. Jevons, Goodhart, Roemer, the Framing Effect, the Productivity Paradox, Conway, Amara, the Hype Cycle, the Bullwhip Effect, and Jensen. One tabbed field guide, one law per tab.',
...

    {
      ...
      desc:     'What a clinical informatics team actually does: route every request that hits the queue, then prove the change in production before it closes. A working team standard, documented so another team can adopt it.',
...

{
...

    {
      ...
      desc:     'In 2008, about 9% of hospitals had a basic EHR. Washington spent $35 billion and got near-universal adoption, two hours of desk work per hour of care, and data that still would not move. The screen you use is the output of an incentive structure.',
